...
if( !function_exists('wolf_get_wp_thumb') ):
function wolf_get_wp_thumb($path, $w = 1920, $h = 1000, $crop = false, $suffix = null, $dest_path = null, $jpeg_quality = 90){

	if(is_string(image_resize($path, $w, $h, $crop, $suffix, $dest_path, $jpeg_quality)))
		return str_replace( ABSPATH, site_url().'/',  image_resize($path, $w, $h, $crop, $suffix, $dest_path, $jpeg_quality));
