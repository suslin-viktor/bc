<?php
require_once( WOLF_FRAMEWORK_DIR . '/classes/class-tgm-plugin-activation.php' );
...
function wolf_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'    => 'Wolf Message Bar',
			'slug'   => 'wolf-message-bar', 
			'source'   => 'http://plugins.wolfthemes.com/wolf-message-bar/wolf-message-bar.zip',
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
			'external_url' => 'http://plugins.wolfthemes.com/wolf-message-bar/wolf-message-bar.zip',
		),
		...
		array(
			'name'    => 'Wolf Widgets Pack',
			'slug'   => 'wolf-widgets-pack', 
			'source'   => 'http://plugins.wolfthemes.com/wolf-widgets-pack/wolf-widgets-pack.zip',
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
			'external_url' => 'http://plugins.wolfthemes.com/wolf-widgets-pack/wolf-widgets-pack.zip',
		)
	...
	$plugins[] =  array(
			'name'    => 'Wolf Sidebars',
			'slug'   => 'wolf-sidebars', 
			'source'   => 'http://plugins.wolfthemes.com/wolf-sidebars/wolf-sidebars.zip',
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
			'external_url' => 'http://plugins.wolfthemes.com/wolf-sidebars/wolf-sidebars.zip',
		);
	...
	$plugins[] = array(
			...
			'source'   => WOLF_THEME_URL . '/includes/admin/plugins/revslider.zip', // The plugin source
			'required' => false, // If false, the plugin is only 'recommended' instead of required
			'version' => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' => WOLF_THEME_URL . '/includes/admin/plugins/revslider.zip', // If set, overrides default API URL and points to an external URL
	);
	 ...
	 */
	$config = array(
		'domain'       		=> 'wolf',         	// Text domain - likely want to be the same as your theme.
